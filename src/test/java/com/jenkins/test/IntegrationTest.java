...
import com.jenkins.test.JenkinsApp;
import com.jenkins.test.config.AsyncSyncConfiguration;
import com.jenkins.test.config.EmbeddedSQL;
...
@SpringBootTest(classes = { JenkinsApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
