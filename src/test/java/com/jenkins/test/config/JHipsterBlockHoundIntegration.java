...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.jenkins.test.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.jenkins.test.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
